"""
to run this test go to command line navigate to folder's dir and execute 'pytest -v -s -m  --browser chrome
...
import pytest
from end_to_end.pages.home_page import HomePage
from end_to_end.pages.header import Header
from end_to_end.pages.cart_page import CartPage
from end_to_end.configs.generic_configs import GenericConfigs
from end_to_end.pages.order_received_page import OrderReceivedPage
from end_to_end.pages.checkout_page import CheckoutPage
...
class TestEndToEndCheckoutGuestUser:
    ...
    def test_end_to_end_checkout_guest_user(self):
        ...
        # go to home page
        """we accomplished this by entering url into command line with help of conftest.py dir"""
