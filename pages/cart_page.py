...
class CartPage:
    ...
    def get_all_product_names(self):
        product_name_elements = self.base.wait_and_get_elements(self.PRODUCT_NAMES_IN_CART)
        product_names = [i for i in product_name_elements]
        # import pdb; pdb.set_trace()
        return product_names

    def input_coupon_code(self, code):
        self.base.wait_and_input_text(self.COUPON_FIELD, code)

    def click_on_apply_coupon_btn(self):
        self.base.wait_and_click(self.APPLY_COUPON_BTN)
    ...
    def get_displayed_message(self):
        text = self.base.wait_and_get_element_text(self.CONFIRMATION_CODE_MSG)
        return text

    def click_proceed_to_checkout_btn(self):
        self.base.wait_and_click(self.PROCEED_TO_CHECKOUT_BTN)
